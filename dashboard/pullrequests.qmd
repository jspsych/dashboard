...
def visualise_merge_time_trend(calculator: MetricsCalculator) -> None:
    ...
    if df.empty:
        ...
        ax.set_title('Median PR Merge Time by Quarter')
        plt.tight_layout()
        plt.show()
        return
    ...
    ax.plot(df['period'], df['community'], marker='o', markersize=4,
            label='Community', color=sns.color_palette('Set2')[1])
    ax.plot(df['period'], df['core'], marker='o', markersize=4,
            label='Core Team', color=sns.color_palette('Set2')[0])
    ax.xaxis.set_major_locator(mdates.YearLocator())
    ax.xaxis.set_major_formatter(mdates.DateFormatter('%Y'))
    ax.set_xlabel('Year')
    ax.set_ylabel('Median Merge Time (days)')
    ax.set_title('Median PR Merge Time by Quarter')
...
```{python}
import htmltools
htmltools.HTML("<span class=\"card-title d-flex align-items-center\"> <i class=\"bi bi-graph-up\"> </i> <span class=\"ms-2\">Median merge time by quarter</span> </span>")
```
...
```{python}
import htmltools
htmltools.HTML("<span class=\"card-title d-flex align-items-center\"> <i class=\"bi bi-person-check\"> </i> <span class=\"ms-2\">Median time to first response by quarter</span> </span>")
```
