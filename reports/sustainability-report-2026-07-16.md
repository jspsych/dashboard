...
| --- | --- | --- | --- | --- |
| Goal 1: Contributors with merge access | `value` (higher is better) | 3 | 3 | no change |
| Goal 2: Community PR review & merge time | `community_median_days` (lower is better) | 0.80 | 5.70 | ▼ 86.0% faster — improved |
| Goal 3: Support responsiveness & participation | `median_first_response_days` (lower is better) | 0.39 | 0.16 | ▲ 141.9% slower — worsened |
| Goal 4: Community-repository contributions | `contributions` (higher is better) | 98 | 158 | ▼ 38.0% fewer — worsened |
| Goal 5: New-contributor growth (core packages) | `new_contributors` (higher is better) | 8 | 15 | ▼ 46.7% fewer — worsened |
...
Headline metric (`value`) (higher is better): Current window: **3** vs. 6 months earlier: **3** (change: +0.0%) — no change
...
Headline metric (`community_median_days`) (lower is better): Current window: **0.8** vs. 6 months earlier: **5.7** (change: -86.0%) — ▼ 86.0% faster — improved

| window_end | community_median_days | core_median_days | community_merge_rate | community_n | core_n |
| --- | --- | --- | --- | --- | --- |
| 2024-10-01 | 2.13 | 0.37 | 65.38 | 17 | 6 |
| 2025-01-01 | 2.13 | 0.60 | 76.67 | 23 | 7 |
| 2025-04-01 | 4.27 | 9.94 | 81.82 | 18 | 7 |
| 2025-07-01 | 19.86 | 4.97 | 61.90 | 13 | 4 |
| 2025-10-01 | 10.09 | — | 50 | 11 | 0 |
| 2026-01-01 | 5.70 | 5.89 | 52.94 | 9 | 1 |
| 2026-04-01 | 5.08 | 5.89 | 77.78 | 7 | 1 |
| 2026-07-01 | 0.80 | 0.01 | 31.25 | 5 | 8 |
...
Headline metric (`median_first_response_days`) (lower is better): Current window: **0.39** vs. 6 months earlier: **0.16** (change: +141.9%) — ▲ 141.9% slower — worsened

| window_end | median_first_response_days | qa_answer_rate | core_response_share_pct | n_discussions |
| --- | --- | --- | --- | --- |
| 2024-10-01 | 0.46 | 26.47 | 13.97 | 48 |
| 2025-01-01 | 0.72 | 12.12 | 20.97 | 47 |
| 2025-04-01 | 5.65 | 12.12 | 13.79 | 40 |
| 2025-07-01 | 3.25 | 13.64 | 8.33 | 28 |
| 2025-10-01 | 1.42 | 22.22 | 11.63 | 16 |
| 2026-01-01 | 0.16 | 20 | 20 | 15 |
| 2026-04-01 | 0.54 | 30.77 | 8.70 | 17 |
| 2026-07-01 | 0.39 | 25 | 10 | 15 |
...
Headline metric (`contributions`) (higher is better): Current window: **98** vs. 6 months earlier: **158** (change: -38.0%) — ▼ 38.0% fewer — worsened
...
Headline metric (`new_contributors`) (higher is better): Current window: **8** vs. 6 months earlier: **15** (change: -46.7%) — ▼ 46.7% fewer — worsened
